...
% plotCamera3d( R, t, 0.4, filename(j).name);
...
quiver3(c(1), c(2), c(3), cam_x(1), cam_x(2), cam_x(3),'r','LineWidth',2);
quiver3(c(1), c(2), c(3), cam_y(1), cam_y(2), cam_y(3),'g','LineWidth',2);
quiver3(c(1), c(2), c(3), cam_z(1), cam_z(2), cam_z(3),'b','LineWidth',2);
text(c(1), c(2), c(3)-0.1, camera_tag, 'Color', 'White');
